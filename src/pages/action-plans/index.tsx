...
function ActionPlanListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('action_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/action-plans/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('action_plan', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/action-plans/create`} passHref legacyBehavior>
